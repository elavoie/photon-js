...
if (process.argv.length === 2) {
    ...
    console.log("    --use_instrumentation=<file> (Add instrumentation code before files)");
    console.log("    -o <file> (Write compiled code in a file without running it)");
    console.log("    --run (Run file after compilation)");
    console.log("    --show_instrumentation_results (Call 'instrumentationResults' function after the program terminates. The function should be supplied by the instrumentation code.)");
