...
FAST_INSTRUMENTATION=/Users/erick/Recherche/photon-js/perf/instrumentation_fast.js
...
results/instrumented/v8/memory/Photon-simple.txt: photon ometa/compiler.js perf/obj.js perf/instrumentation.js
	pushd benchmarks/v8-v7; \
...
results/instrumented/sunspider/memory/Photon-simple.txt: photon ometa/compiler.js perf/obj.js perf/instrumentation.js
...
results/instrumented/v8/memory/Photon-fast.txt: photon ometa/compiler.js perf/obj.js perf/instrumentation_fast.js
	pushd benchmarks/v8-v7; \
...
results/instrumented/sunspider/memory/Photon-fast.txt: photon ometa/compiler.js perf/obj.js perf/instrumentation_fast.js
...
results/instrumented/sunspider/time/Photon-simple.txt: photon ometa/compiler.js perf/obj.js perf/instrumentation.js
	pushd benchmarks/sunspider/; \
...
results/instrumented/v8/time/Photon-simple.txt: photon ometa/compiler.js perf/obj.js perf/instrumentation.js
	pushd benchmarks/v8-v7; \
        photon v8.js --use_instrumentation=$(SIMPLE_INSTRUMENTATION) > ../../results/instrumented/v8/time/Photon-simple.txt; \
    popd

results/instrumented/sunspider/time/Photon-fast.txt: photon ometa/compiler.js perf/obj.js perf/instrumentation_fast.js
	pushd benchmarks/sunspider/; \
        ./sunspider --shell=photon --args=--use_instrumentation=$(FAST_INSTRUMENTATION) > ../../results/instrumented/sunspider/time/Photon-fast.txt; \
    popd

results/instrumented/v8/time/Photon-fast.txt: photon ometa/compiler.js perf/obj.js perf/instrumentation_fast.js
	pushd benchmarks/v8-v7; \
...
tables: time-exps mem-exps 
	...
	./results2latex.sh -v8 --ratio Photon/Photon-simple --ratio Photon/Photon-fast  $(ABRV) results/baseline/v8/time/Photon.txt results/baseline/v8/time/SpiderMonkey.txt results/instrumented/v8/time/Photon-simple.txt results/instrumented/v8/time/Photon-fast.txt > results/instrumented/v8/time/table.tex
	./results2latex.sh -sunspider  --ratio Photon-simple/Photon --ratio Photon-fast/Photon $(ABRV) results/baseline/sunspider/time/Photon.txt results/baseline/sunspider/time/SpiderMonkey.txt results/instrumented/sunspider/time/Photon-simple.txt results/instrumented/sunspider/time/Photon-fast.txt > results/instrumented/sunspider/time/table.tex
	...
	./mem2latex.sh --ratio Photon-simple/Photon --ratio Photon-fast/Photon $(ABRV) results/baseline/v8/memory/Photon.txt results/instrumented/v8/memory/Photon-simple.txt results/instrumented/v8/memory/Photon-fast.txt > results/instrumented/v8/memory/table.tex
	./mem2latex.sh --ratio Photon-simple/Photon --ratio Photon-fast/Photon $(ABRV) results/baseline/sunspider/memory/Photon.txt results/instrumented/sunspider/memory/Photon-simple.txt results/instrumented/sunspider/memory/Photon-fast.txt > results/instrumented/sunspider/memory/table.tex
